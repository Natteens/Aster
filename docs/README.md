...
4. Keep the [CLI reference](reference/cli.md) nearby.

## Language reference

- [Application entry points](reference/application-entry.md)
- [Namespaces and `using`](reference/namespaces.md)
...
- [Tasks, parallel operations, and worker boundaries](reference/concurrency.md)
...
- [Architecture and crate boundaries](compiler/architecture.md)
...
- [Writing documentation](contributing/writing.md)
